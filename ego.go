...
//line directory.ego:15
	_, _ = io.WriteString(w, "\n<h1>")
//line directory.ego:15
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(dir.Name)))
//line directory.ego:15
	_, _ = io.WriteString(w, " (")
//line directory.ego:15
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(len(dir.Folders))))
//line directory.ego:15
	_, _ = io.WriteString(w, ")</h1>\n<div class=\"content\">\n<table>\n\t<th><td>Count</td><td>Size</td>\n\t</th><tr><td>Unread</td>\n\t\t<td>")
//line directory.ego:20
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Comma(s.Unread.Count))))
//line directory.ego:20
	_, _ = io.WriteString(w, " [")
//line directory.ego:20
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(s.Unread.Count*100/t.Count)))
//line directory.ego:20
	_, _ = io.WriteString(w, "%%]</td>\n\t\t<td>")
//line directory.ego:21
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Bytes(uint64(s.Unread.Size)))))
//line directory.ego:21
	_, _ = io.WriteString(w, " [")
//line directory.ego:21
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(s.Unread.Size*100/t.Size)))
//line directory.ego:21
	_, _ = io.WriteString(w, "%%]</dd>\n\t</tr><tr><td>Deleted</td>\n\t\t<td>")
//line directory.ego:23
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Comma(s.Deleted.Count))))
//line directory.ego:23
	_, _ = io.WriteString(w, " [")
//line directory.ego:23
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(s.Deleted.Count*100/t.Count)))
//line directory.ego:23
	_, _ = io.WriteString(w, "%%]</td>\n\t\t<td>")
//line directory.ego:24
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Bytes(uint64(s.Deleted.Size)))))
//line directory.ego:24
	_, _ = io.WriteString(w, " [")
//line directory.ego:24
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(s.Deleted.Size*100/t.Size)))
//line directory.ego:24
	_, _ = io.WriteString(w, "%%]</dd>\n\t</tr><tr>\n\t<td>Messages</td>\n\t\t<td>")
//line directory.ego:27
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Comma(t.Count))))
//line directory.ego:27
	_, _ = io.WriteString(w, "</td>\n\t\t<td>")
//line directory.ego:28
	_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(humanize.Bytes(uint64(t.Size)))))
//line directory.ego:28
...
//line directory.ego:36
		_, _ = io.WriteString(w, "\n\t<tr><td>")
//line directory.ego:36
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(n)))
//line directory.ego:36
		_, _ = io.WriteString(w, "</td>\n\t\t<td>")
...
//line folder.ego:14
		_, _ = io.WriteString(w, "\n\t\t<li class=\"")
//line folder.ego:14
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(m.cClass())))
//line folder.ego:14
...
//line folder.ego:16
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(m.hSubject())))
//line folder.ego:16
		_, _ = io.WriteString(w, "</span>\n\t\t\t<span>")
//line folder.ego:17
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(m.hSender())))
//line folder.ego:17
		_, _ = io.WriteString(w, "</span>\n\t\t</a></li>\n    ")
//line folder.ego:19
	}
...
//line folders.ego:4
		_, _ = io.WriteString(w, "\n\t\t<li><a href=\"")
//line folders.ego:4
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(d.UrlPath())))
//line folders.ego:4
		_, _ = io.WriteString(w, "\">")
//line folders.ego:4
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(d.Label())))
//line folders.ego:4
...
//line folders.ego:7
		_, _ = io.WriteString(w, "\n\t\t<li class=\"")
//line folders.ego:7
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(f.cClass())))
//line folders.ego:7
		_, _ = io.WriteString(w, "\"><a href=\"")
//line folders.ego:7
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(f.UrlPath())))
//line folders.ego:7
		_, _ = io.WriteString(w, "\">")
//line folders.ego:7
		_, _ = io.WriteString(w, html.EscapeString(fmt.Sprint(f.Label())))
//line folders.ego:7
